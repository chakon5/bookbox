    ...
    <h2 class="text-center my-3"><BR>จัดการ STOCK BOOK BOX</h2>
        ...
        <form action="UPDATE.php" method="post" class="form-group">
            <div class="form-group">
                ...
                <input type="text" name="publish" value="<?php print $row->publish; ?>" class="form-control">

                <label for="company">บริษัท</label>
                <input type="text" name="company" value="<?php print $row->company; ?>" class="form-control">

                <label for="price">ราคา</label>
                <input type="text" name="price" value="<?php print $row->price; ?>" class="form-control">

                <label for="amount">จำนวนคงเหลือ</label>
                <input type="text" name="amount" value="<?php print $row->amount; ?>" class="form-control">

                <label for="img">รูปสินค้า</label>
                <input type="file" name="img"  value="<?php print $row->img; ?>"class="form-control">
            </div>
